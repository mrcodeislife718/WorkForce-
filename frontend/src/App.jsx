...
import { StoreCatalogProvider } from './contexts/StoreCatalogContext.jsx'
import Navigation from './components/Navigation'
import ProtectedRoute from './components/ProtectedRoute'
import Home from './components/Home.jsx'
import WorkerDetail from './components/WorkerDetail.jsx'
import WorkforceBundleDetail from './components/WorkforceBundleDetail.jsx'
        ...
        <AuthProvider>
          <StoreCatalogProvider>
            <div id="app-root" style={{
              ...
              <Navigation />
              <Routes>
                <Route path="/" element={<Navigate to="/store/employees" replace />} />
                <Route path="/store" element={<Navigate to="/store/employees" replace />} />
                <Route path="/store/bundles/:slug" element={<WorkforceBundleDetail />} />
                <Route path="/store/:view" element={<Home />} />
